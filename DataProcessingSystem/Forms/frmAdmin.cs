...
namespace DataProcessingSystem
{
    public partial class frmAdmin : Form
    {
        ...
        {
            InitializeComponent();
            btnQuery.Visible = frmLogin.position == "City Admin";
            pictureBox6.Visible = frmLogin.position == "City Admin";
        }
        ...
        private void frmAdmin_Load(object sender, EventArgs e)
        {
            ...
            lblPosition.Text = frmLogin.position == "City Admin" ? "PPO III" : "Barangay Admin";
        }

        private void btnHome_Click(object sender, EventArgs e)
        {
            Application.OpenForms.OfType<Form>().Where(x => x.Name != "Main" && x.Name != "frmAdmin").ToList().ForEach(x => x.Close());
            frmHome fh = new frmHome();
            fh.TopLevel = false;
            fh.Dock = DockStyle.Fill;
            fh.Show();
